...
- 39 test files.
- 49 direct `supabase.auth.getUser()` calls.
...
- Open: F-006 follow-up for the remaining page/server-action permission helpers, especially social pages, the task list page, remaining client subpages, remaining forms pages, and quizzes.
