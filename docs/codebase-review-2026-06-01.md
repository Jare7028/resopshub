...
- 39 test files.
- 61 direct `supabase.auth.getUser()` calls.
...
- Open: F-006 follow-up for the remaining page/server-action permission helpers, especially personal editor actions, social pages, task mutations, remaining client subpages, forms, and quizzes.
