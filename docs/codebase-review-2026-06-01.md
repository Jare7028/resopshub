...
- 39 test files.
- 53 direct `supabase.auth.getUser()` calls.
...
- Open: F-006 follow-up for the remaining page/server-action permission helpers, especially social pages, task detail mutations/pages, remaining client subpages, remaining forms pages, and quizzes.
