...
- `app/(app)/settings/page.tsx`: 4520 lines after the settings page utility, group-summary, template relationship, custom-field summary, profile/status row, template URL, subtask redirect, and project-template link redirect extraction slices.
...
- `app/(app)/settings/page.tsx` is 4520 lines after the settings utility, group-summary, template relationship, custom-field summary, profile/status row, template URL, subtask redirect, and project-template link redirect extraction slices and still contains many management forms/actions.
