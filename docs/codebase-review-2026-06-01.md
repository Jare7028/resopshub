...
| `npm test` | Passed | 67 test files, 407 tests passed. |
...
- `npm test -- --run lib/employeeInfoAccess.test.ts`: passed, 7 tests.
...
- `app/(app)/projects/page.tsx:1265`, `app/(app)/schedules/page.tsx:419`, `app/(app)/schedules/[clientId]/page.tsx:1099`, `app/(app)/social/[pageId]/page.tsx:1670`, and `app/(app)/employee-info/page.tsx:1866` use the same route-modal pattern.
...
- `app/(app)/employee-info/page.tsx`: 2000 lines after the shared access-gate and column-management helper extractions.
...
- The inventory page is 1250 lines and the employee-info page is 2000 lines after the shared access-gate and column-management helper extractions; their table components remain the larger F-012 UI split targets.
