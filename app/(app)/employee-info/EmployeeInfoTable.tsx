...
const EMPLOYEE_INFO_POPOVER_DATA_ATTRIBUTE = "data-employee-info-popover";
const EMPLOYEE_INFO_CURRENCY_SELECTOR_DATA_ATTRIBUTE =
  "data-employee-info-currency-selector";
const EMPLOYEE_INFO_MENU_INTERACTION_CONFIG = {
  popoverDataAttribute: EMPLOYEE_INFO_POPOVER_DATA_ATTRIBUTE,
  currencySelectorDataAttribute: EMPLOYEE_INFO_CURRENCY_SELECTOR_DATA_ATTRIBUTE,
...
export default function EmployeeInfoTable({
  ...
  const queueTableRefresh = useCallback(() => {
    const attemptRefresh = () => {
      if (openMenuRef.current || hasEditablePopoverOpen(EMPLOYEE_INFO_POPOVER_DATA_ATTRIBUTE)) {
  ...
  const handleInputBlur = (event: FocusEvent<HTMLInputElement>) => {
    ...
    const isCurrencySelectorTarget = isEditableCurrencySelectorTarget(
      blurIntentTarget,
      EMPLOYEE_INFO_CURRENCY_SELECTOR_DATA_ATTRIBUTE
    );
    const isMenuInteractionTarget = isEditableMenuInteractionTarget(
      blurIntentTarget,
      EMPLOYEE_INFO_MENU_INTERACTION_CONFIG
    );
  ...
  }, [clientFilters, columnOptionFilters, columnTextFilters, fullNameFilter]);
